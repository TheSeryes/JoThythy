...
public class BaseCustomEditor : Editor
{
    ...
    private Color32 CompanyColor01 = new Color32(35, 208, 185, 255);
    private Color32 CompanyColor02 = new Color32(31, 31, 31, 255);
    ...
    private void CreateStyle()
    {
        ...
        m_SubtitleStyle.normal.textColor = CompanyColor02;
    ...
    protected void DrawSeparator(bool aMain)
    {
        GUILayout.Space(10f);
        if(aMain)
            GUI.color = CompanyColor01;
        else
            GUI.color = CompanyColor02;
